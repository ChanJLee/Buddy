...
public class PullScrollView extends ScrollView {
    ...
    private final static short STATE_UP = 0x0521;
    private final static short STATE_DOWN = 0x0525;
    private final static short STATE_NORMAL = 0x1212;

    /** 状态. */
    private short mState = STATE_NORMAL;
    ...
    private void doActionMove(MotionEvent event) {
        ...
        if (deltaY < 0 && mState == STATE_NORMAL) {
            mState =STATE_UP;
        } else if (deltaY > 0 && mState == STATE_NORMAL) {
            mState = STATE_DOWN;
        }
